      ...
      <section className="bg-gradient-to-b from-secondary/20 to-background py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center mt-10">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Olives of Wholeness Healing Centre is committed to protecting your
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          <Card>
            ...
            <CardContent className="prose-p:text-muted-foreground prose-p:leading-relaxed">
              <p>
                We are Olives of Wholeness Healing Centre (“Olives of
                Wholeness”). Our website address is:{" "}
                <Link
                  href="https://www.olivesofwholeness.org"
            ...
            <CardContent className="space-y-6 prose-p:text-muted-foreground prose-p:leading-relaxed text-muted-foreground">
              ...
              <div className="bg-secondary/30 p-4 rounded-lg border border-border">
                ...
                <p className="mb-3">
                  ...
                  Olives of Wholeness from contacting you for marketing purposes
                  or giving your data to our partners.
                </p>
                <p>
                  When Olives of Wholeness processes your order, it may send
                  your data to, and use the resulting information from, credit
                  reference agencies to fraudulent purchases.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card>
              ...
              <CardContent className="text-muted-foreground leading-relaxed">
                <p>
                  Information submitted through contact forms is used for
                  customer service purposes and is handled confidentially.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="text-muted-foreground leading-relaxed">
                <p>
                  We use analytics tools to help us understand how visitors
                  engage with our website, so that we can improve it.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4 prose-p:text-muted-foreground prose-p:leading-relaxed text-muted-foreground">
              ...
              <ul className="list-disc pl-6 space-y-4">
                <li>
                  <strong className="text-foreground">Functionality</strong> –
                  Olives of Wholeness uses these cookies so that we recognise
                  you on our website and remember your previously selected
                  preferences. This could include what language you prefer and
                  location you are in. A mix of first-party and third-party
                  cookies are used.
                </li>
                <li>
                  <strong className="text-foreground">Advertising</strong> –
                  Olives of Wholeness uses these cookies to collect information
                  about your visit to our website, the content you viewed, the
                  links you followed and information about your browser, device,
                  and your IP address. DAS sometimes shares some limited aspects
                  of this data with third parties for advertising purposes. We
              ...
              <p className="pt-2">
                You can set your browser to not accept cookies, however, in a
              ...
              <div className="bg-primary/5 p-4 rounded-lg mt-4 flex items-center justify-between border border-primary/10">
                <p className="text-foreground font-medium m-0">
                  For our full Cookie Policy, please see here:
                </p>
                <Button asChild variant="outline" size="sm">
                  <Link href="/cookie-policy">Cookie Policy Page</Link>
                </Button>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4 prose-p:text-muted-foreground prose-p:leading-relaxed">
              ...
              <p>
                ...
                in to that website. Our Privacy Policy applies only to our
          ...
          <Card className="border-primary/20 shadow-md">
            ...
            <CardContent className="pt-6 space-y-4 text-muted-foreground">
              <p className="mb-6">
                Olives of Wholeness would like to make sure you are fully aware
                of all your data protection rights. Every user is entitled to
                the following:
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-background border border-border p-4 rounded-lg">
                  ...
                  <span className="text-sm">
                    You have the right to request from Olives of Wholeness
                ...
                <div className="bg-background border border-border p-4 rounded-lg">
                  ...
                  <span className="text-sm">
                    You have the right to request that Olives of Wholeness
                    correct any information you believe is incorrect. You also
                    have the right to request DAS Healthcare Limited complete
                ...
                <div className="bg-background border border-border p-4 rounded-lg">
                  ...
                  <span className="text-sm">
                    You have the right to request Olives of Wholeness erase your
                ...
                <div className="bg-background border border-border p-4 rounded-lg">
                  ...
                  <span className="text-sm">
                    You have the right to object to Olives of Wholeness
          ...
          <Card>
            ...
            <CardContent className="space-y-6 text-muted-foreground prose-p:leading-relaxed">
              <div>
                <p className="mb-2">
                  Olives of Wholeness keeps its privacy policy under regular
                  review and places any updates on this page. This Privacy
                  Policy was last updated on{" "}
                  <strong className="text-foreground">2nd April, 2026</strong>.
                </p>
                <p>
