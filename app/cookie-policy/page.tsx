      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 text-foreground prose-p:text-muted-foreground prose-p:leading-relaxed prose-headings:text-foreground">
          <p className="mb-8">
            ...
            accessible from{" "}
            <a href="https://www.olivesofwholeness.org" className="text-primary hover:underline">
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-4">Disabling Cookies</h2>
            <p>
          ...
          <div>
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-6">
              <li>
